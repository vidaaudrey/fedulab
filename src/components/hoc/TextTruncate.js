...
/* eslint-disable no-plusplus, react/forbid-prop-types, no-unused-vars */
...
class TextTruncate extends React.Component {
  ...
  measureWidth = text => this.canvas.measureText(text).width;
...
export default compose(setDisplayName('TextTruncate'), pure)(TextTruncate);
